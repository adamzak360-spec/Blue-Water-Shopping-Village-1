...
function getPaystackFeeConfig({ country = 'GH', currency = 'GHS', payoutMethod }) {
  ...
  return {
    ...
    payoutMethod: method,
    feeMinor,
    minimumTransferMinor: integerEnv('PAYSTACK_GHS_MINIMUM_TRANSFER_MINOR', 1000),
...
// Current published Ghana defaults are GHS 1.00 for mobile money, GHS 8.00 for
// bank transfers, and GHS 10.00 as the minimum transfer. Update environment
// values when Paystack pricing changes.
