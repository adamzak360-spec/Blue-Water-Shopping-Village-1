...
const slides = [
  { title: 'Reliable Premium Marketplace', summary: 'Company mission, platform promise, and operating model.' },
  { title: 'From discovery to delivery', summary: 'The customer path from public catalogue to fulfilment.' },
  { title: 'Seller tools that support real operations', summary: 'Storefront, catalogue, orders, chat, delivery, and payouts.' },
  { title: 'Visibility is controlled and reversible', summary: 'Store-only defaults, packages, and free catalog mode.' },
  { title: 'Trust is built into payments and payouts', summary: 'Settlement discipline, wallet accumulation, and idempotent transfers.' },
